...
void Adafruit_LSM303_Accel_Unified::read()
{
  ...
  #else
    i2c.send(LSM303_REGISTER_ACCEL_OUT_X_L_A | 0x80);
  #endif
  i2c.endTransmission();
  i2c.requestFrom((byte)LSM303_ADDRESS_ACCEL);
...
void Adafruit_LSM303_Mag_Unified::read()
{
  ...
  #else
    i2c.send(LSM303_REGISTER_MAG_OUT_X_H_M);
  #endif
  i2c.endTransmission();
  i2c.requestFrom((byte)LSM303_ADDRESS_MAG);
